      ...
      <section className="flex items-center justify-center bg-black">
        <div className="flex flex-col items-start gap-2 text-white">
          ...
          <div className="flex mt-4">
            <Button className="bg-purple-700 text-white py-4 px-8">Ver Ingressos</Button>
          </div>

        </div>
        <div>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQV37N-9OAxIYoZe3DjuJKC6niSNZfwBihKHj8J7RyF6w&s=10" alt="Rock in Rio 2026" />
        </div>
      </section>
